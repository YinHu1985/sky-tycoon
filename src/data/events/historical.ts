...
How will you respond to this challenge?`,
  ...
  },
  {
    ...
    description: 'London becomes the first city to host the Summer Olympics three times.',
    startDate: new Date(2012, 6, 27), // July 2012
    endDate: new Date(2012, 7, 12),
    mtth: 10,
    oneTime: true,
    modal: true,
    triggers: [],
  ...
  },
  {
    ...
    startDate: new Date(2016, 7, 5), // Aug 2016
  ...
  },
  {
    ...
    description: 'Tokyo hosts the Games again, showcasing cutting-edge technology and resilience.',
    startDate: new Date(2021, 6, 23), // July 2021 (delayed)
    endDate: new Date(2021, 7, 8),
    mtth: 10,
    oneTime: true,
    modal: true,
    triggers: [],
  ...
  },
  {
    ...
    description: 'Paris hosts the Games, celebrating a century since it last hosted in 1924.',
    startDate: new Date(2024, 6, 26), // July 2024
  ...
  {
    id: 'olympics_2028_lax',
    title: '2028 Los Angeles Olympics',
    description: 'Los Angeles becomes the third city to host the Summer Olympics three times.',
    startDate: new Date(2028, 6, 14), // July 2028
    endDate: new Date(2028, 6, 30),
    mtth: 10,
    oneTime: true,
    modal: true,
    triggers: [],
    ...
    options: [
      {
        label: 'Golden State Games',
        description: 'Tourism in Los Angeles booms! (+50% Tourism for 2 months)',
        effects: [
          {
            type: 'addModifier',
            modifier: {
              id: 'olympics_2028_boom',
              source: 'event_olympics_2028',
              type: 'multiplier',
              target: 'cityTour',
              value: 1.5,
              context: { cityId: 'lax' },
  ...
  {
    id: 'olympics_2032_bne',
    title: '2032 Brisbane Olympics',
    description: 'The Games return to Australia, hosted by the sunny city of Brisbane.',
    startDate: new Date(2032, 6, 23), // July 2032
    endDate: new Date(2032, 7, 8),
    mtth: 10,
    oneTime: true,
    modal: true,
    triggers: [],
    ...
    options: [
      {
        ...
        description: 'Tourism in Brisbane booms! (+50% Tourism for 2 months)',
        effects: [
          {
            type: 'addModifier',
            modifier: {
              id: 'olympics_2032_boom',
              source: 'event_olympics_2032',
              type: 'multiplier',
              target: 'cityTour',
              value: 1.5,
              context: { cityId: 'bne' },
              expireDuration: 60,
              description: 'Brisbane Olympics Boom'
            }
          }
        ]
      }
