...
export const accidentEvents: GameEvent[] = [
  {
    ...
    modal: true,
    triggers: [
      (state: GameState, company: Company) => company.maintenanceEffort < 50 // Only if maintenance is lax
    ],
    mtth_modifiers: [
      {
         condition: (state: GameState, company: Company) => company.maintenanceEffort < 20,
  ...
  },
  {
    ...
    modal: true,
    triggers: [
       (state: GameState, company: Company) => company.serviceEffort < 40 // Low service/pay effort triggers it
    ],
    mtth_modifiers: [],
    options: [
      {
  ...
  },
  {
    ...
    triggers: [],
    mtth_modifiers: [
       { factor: 0.5, condition: (state: GameState, company: Company) => company.maintenanceEffort < 40 }
    ],
    options: [
      {
