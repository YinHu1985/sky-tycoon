...
import {
  ...
  Plane, Map as MapIcon, TrendingUp, Star, Trophy
} from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ onOpenWindow }) => {
  const {
  ...
  // I need to verify the store state property names.
  ...
  // So it is `isPaused` and `gameSpeed`.
  // I need to check the actions in useGameStore.ts to know the setter names.
