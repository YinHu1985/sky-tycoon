...
import { X, Trophy, TrendingUp, Plane, Map, Eye, EyeOff } from 'lucide-react';
...
export const CompanyList = () => {
  ...
  const sortedCompanies = [...companies].sort((a, b) => b.fame - a.fame);

  return (
    <div className="w-full min-w-[900px] max-h-[60vh] overflow-hidden flex flex-col">
      <div className="overflow-y-auto flex-1">
        <table className="w-full text-left border-collapse table-fixed">
          ...
          {sortedCompanies.map((company, index) => {
            ...
            const weeklyProfit = company.stats.netIncome;
            ...
            return (
              ...
              >
                ...
                <td className="p-3 text-right font-mono text-yellow-400">{Math.floor(company.fame)}</td>
