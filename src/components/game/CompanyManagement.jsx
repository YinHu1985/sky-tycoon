...
export const CompanyManagement = () => {
  ...
  const [prBudget, setPrBudget] = useState(company.prBudget);
    ...
    <div className="w-[500px] space-y-6">
      ...
      <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/20 p-4 rounded-lg border border-purple-600">
        ...
        <div className="flex items-baseline gap-3">
          <div className="text-5xl font-bold text-yellow-400">{company.fame.toFixed(1)}</div>
